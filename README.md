...
| Investigation workflow | Persistent row tags, bulk tagging of filtered results, message-ID and subject extraction, a filter-scoped deduplicated two-column MessageIds/Subjects CSV with automatic prerequisite analysis, Microsoft app-ID mapping, and tracker-ready Event narratives |
